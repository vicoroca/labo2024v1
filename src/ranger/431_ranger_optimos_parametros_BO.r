...
param <- list(
  "num.trees" = 367, # cantidad de arboles
  "mtry" = 50,
  "min.node.size" = 618, # tamaño minimo de las hojas
...
dir.create("./exp/KA4310_BO/", showWarnings = FALSE)
archivo_salida <- "./exp/KA4310_BO/KA4310_BO_001.csv"
