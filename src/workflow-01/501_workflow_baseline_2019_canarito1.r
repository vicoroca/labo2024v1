...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_CANARITO1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_CANARITO1", "DT001_CANARITO1" )
  
  DR_drifting_guantesblancos( "DR001_CANARITO1", "CA001_CANARITO1" )
  FE_historia_guantesblancos( "FE001_CANARITO1", "DR001_CANARITO1" )
  
  TS_strategy_guantesblancos_202109( "TS001_CANARITO1", "FE001_CANARITO1" )
  
  HT_tuning_guantesblancos( "HT001_CANARITO1", "TS001_CANARITO1" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_CANARITO1", c("HT001_CANARITO1","TS001_CANARITO1") )
...
corrida_guantesblancos_202109( "CAN1" )
