...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$meta$script <- "/src/workflow-01/541_FE_boruta.r"
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT000B1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000B1", "DT000B1" )

  DR_drifting_guantesblancos( "DR000B1", "CA000B1" )
  FE_historia_guantesblancos( "FE000B1", "DR000B1" )

  TS_strategy_guantesblancos_202109( "TS000B1", "FE000B1" )

  HT_tuning_guantesblancos( "HT000B1", "TS000B1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000B1", c("HT000B1","TS000B1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS000B2", "FE000B1" )

  HT_tuning_guantesblancos( "HT000B2", "TS000B2" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000B2", c("HT000B2", "TS000B2") )
