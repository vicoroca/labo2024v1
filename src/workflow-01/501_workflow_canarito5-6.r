...
FE_historia_guantesblancos <- function( pmyexp, pinputexps, pserver="local")
{
  ...
  param_local$CanaritosAsesinos$desvios <- 2
...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT000_canarito_5", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000_canarito_5", "DT000_canarito_5" )

  DR_drifting_guantesblancos( "DR000_canarito_5", "CA000_canarito_5" )
  FE_historia_guantesblancos( "FE000_canarito_5", "DR000_canarito_5" )

  TS_strategy_guantesblancos_202109( "TS000_canarito_5", "FE000_canarito_5" )

  HT_tuning_guantesblancos( "HT000_canarito_5", "TS000_canarito_5" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_5", c("HT000_canarito_5","TS000_canarito_5") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS000_canarito_6", "FE000_canarito_5" )

  HT_tuning_guantesblancos( "HT000_canarito_6", "TS000_canarito_6" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_6", c("HT000_canarito_6", "TS000_canarito_6") )
...
corrida_guantesblancos_202109( "canarito5" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "canarito6" )
