...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT000_canarito_9", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000_canarito_9", "DT000_canarito_9" )

  DR_drifting_guantesblancos( "DR000_canarito_9", "CA000_canarito_9" )
  FE_historia_guantesblancos( "FE000_canarito_9", "DR000_canarito_9" )

  TS_strategy_guantesblancos_202109( "TS000_canarito_9", "FE000_canarito_9" )

  HT_tuning_guantesblancos( "HT000_canarito_9", "TS000_canarito_9" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_9", c("HT000_canarito_9","TS000_canarito_9") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS000_canarito_10", "FE000_canarito_9" )

  HT_tuning_guantesblancos( "HT000_canarito_10", "TS000_canarito_10" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_10", c("HT000_canarito_10", "TS000_canarito_10") )
...
corrida_guantesblancos_202109( "canarito9" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "canarito10" )
