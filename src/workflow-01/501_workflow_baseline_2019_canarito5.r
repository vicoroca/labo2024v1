...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_CANARITO5", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_CANARITO5", "DT001_CANARITO5" )
  
  DR_drifting_guantesblancos( "DR001_CANARITO5", "CA001_CANARITO5" )
  FE_historia_guantesblancos( "FE001_CANARITO5", "DR001_CANARITO5" )
  
  TS_strategy_guantesblancos_202109( "TS001_CANARITO5", "FE001_CANARITO5" )
  
  HT_tuning_guantesblancos( "HT001_CANARITO5", "TS001_CANARITO5" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_CANARITO5", c("HT001_CANARITO5","TS001_CANARITO5") )
...
corrida_guantesblancos_202109( "CAN5" )
