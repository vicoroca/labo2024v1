...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_CANARITO4", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_CANARITO4", "DT001_CANARITO4" )
  
  DR_drifting_guantesblancos( "DR001_CANARITO4", "CA001_CANARITO4" )
  FE_historia_guantesblancos( "FE001_CANARITO4", "DR001_CANARITO4" )
  
  TS_strategy_guantesblancos_202109( "TS001_CANARITO4", "FE001_CANARITO4" )
  
  HT_tuning_guantesblancos( "HT001_CANARITO4", "TS001_CANARITO4" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_CANARITO4", c("HT001_CANARITO4","TS001_CANARITO4") )
...
corrida_guantesblancos_202109( "CAN4" )
