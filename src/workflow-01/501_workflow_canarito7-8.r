...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT000_canarito_7", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000_canarito_7", "DT000_canarito_7" )

  DR_drifting_guantesblancos( "DR000_canarito_7", "CA000_canarito_7" )
  FE_historia_guantesblancos( "FE000_canarito_7", "DR000_canarito_7" )

  TS_strategy_guantesblancos_202109( "TS000_canarito_7", "FE000_canarito_7" )

  HT_tuning_guantesblancos( "HT000_canarito_7", "TS000_canarito_7" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_7", c("HT000_canarito_7","TS000_canarito_7") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS000_canarito_8", "FE000_canarito_7" )

  HT_tuning_guantesblancos( "HT000_canarito_8", "TS000_canarito_8" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_8", c("HT000_canarito_8", "TS000_canarito_8") )
...
corrida_guantesblancos_202109( "canarito7" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "canarito8" )
