...
corrida_CANARITO1_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  DT_incorporar_dataset_default( "DT000C1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000C1", "DT000C1" )

  DR_drifting_guantesblancos( "DR000C1", "CA000C1" )
  FE_historia_guantesblancos( "FE000C1", "DR000C1" )

  TS_strategy_guantesblancos_202109( "TS000C1", "FE000C1" )

  HT_tuning_guantesblancos( "HT000C1", "TS000C1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000C1", c("HT000C1","TS000C1") )
...
corrida_CANARITO2_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  if( -1 == exp_wf_init( pnombrewf, pvirgen) ) return(0) # linea fija

  # Ya tengo corrido FE0001 y parto de alli
  TS_strategy_guantesblancos_202107( "TS000C2", "FE000C1" )

  HT_tuning_guantesblancos( "HT000C2", "TS000C2" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000C2", c("HT000C2", "TS000C2") )
...
corrida_CANARITO1_202109( "CAN01" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_CANARITO2_202107( "CAN02" )
