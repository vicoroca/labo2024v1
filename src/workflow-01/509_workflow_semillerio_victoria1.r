...
corrida_baseline_semillerio_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_baseline_202109( "TS0001-sem-2", "FE0001-sem" )

  HT_tuning_baseline( "HT0001-sem-2", "TS0001-sem-2" )

  # El ZZ depente de HT y TS
  ZZ_final_semillerio_baseline( "ZZ0001-sem-2", c("HT0001-sem-2","TS0001-sem-2") )
...
corrida_baseline_semillerio_202109( "basem01-2" )
