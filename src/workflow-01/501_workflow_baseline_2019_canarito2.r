...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_CANARITO2", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_CANARITO2", "DT001_CANARITO2" )
  
  DR_drifting_guantesblancos( "DR001_CANARITO2", "CA001_CANARITO2" )
  FE_historia_guantesblancos( "FE001_CANARITO2", "DR001_CANARITO2" )
  
  TS_strategy_guantesblancos_202109( "TS001_CANARITO2", "FE001_CANARITO2" )
  
  HT_tuning_guantesblancos( "HT001_CANARITO2", "TS001_CANARITO2" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_CANARITO2", c("HT001_CANARITO2","TS001_CANARITO2") )
...
corrida_guantesblancos_202109( "CAN2" )
