...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT000_canarito_1", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000_canarito_1", "DT000_canarito_1" )

  DR_drifting_guantesblancos( "DR000_canarito_1", "CA000_canarito_1" )
  FE_historia_guantesblancos( "FE000_canarito_1", "DR000_canarito_1" )

  TS_strategy_guantesblancos_202109( "TS000_canarito_1", "FE000_canarito_1" )

  HT_tuning_guantesblancos( "HT000_canarito_1", "TS000_canarito_1" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_1", c("HT000_canarito_1","TS000_canarito_1") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS000_canarito_2", "FE000_canarito_1" )

  HT_tuning_guantesblancos( "HT000_canarito_2", "TS000_canarito_2" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_2", c("HT000_canarito_2", "TS000_canarito_2") )
...
corrida_guantesblancos_202109( "canarito1" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "canarito2" )
