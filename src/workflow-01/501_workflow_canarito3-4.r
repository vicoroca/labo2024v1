...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT000_canarito_3", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA000_canarito_3", "DT000_canarito_3" )

  DR_drifting_guantesblancos( "DR000_canarito_3", "CA000_canarito_3" )
  FE_historia_guantesblancos( "FE000_canarito_3", "DR000_canarito_3" )

  TS_strategy_guantesblancos_202109( "TS000_canarito_3", "FE000_canarito_3" )

  HT_tuning_guantesblancos( "HT000_canarito_3", "TS000_canarito_3" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_3", c("HT000_canarito_3","TS000_canarito_3") )
...
corrida_guantesblancos_202107 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  TS_strategy_guantesblancos_202107( "TS000_canarito_4", "FE000_canarito_3" )

  HT_tuning_guantesblancos( "HT000_canarito_4", "TS000_canarito_4" )

  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ000_canarito_4", c("HT000_canarito_4", "TS000_canarito_4") )
...
corrida_guantesblancos_202109( "canarito3" )


# Luego partiendo de  FE0001
# genero TS0002, HT0002 y ZZ0002

corrida_guantesblancos_202107( "canarito4" )
