...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_CANARITO3", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_CANARITO3", "DT001_CANARITO3" )
  
  DR_drifting_guantesblancos( "DR001_CANARITO3", "CA001_CANARITO3" )
  FE_historia_guantesblancos( "FE001_CANARITO3", "DR001_CANARITO3" )
  
  TS_strategy_guantesblancos_202109( "TS001_CANARITO3", "FE001_CANARITO3" )
  
  HT_tuning_guantesblancos( "HT001_CANARITO3", "TS001_CANARITO3" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_CANARITO3", c("HT001_CANARITO3","TS001_CANARITO3") )
...
corrida_guantesblancos_202109( "CAN3" )
