...
corrida_guantesblancos_202109 <- function( pnombrewf, pvirgen=FALSE )
{
  ...
  DT_incorporar_dataset_default( "DT001_BORUTA40", "competencia_2024.csv.gz")
  CA_catastrophe_default( "CA001_BORUTA40", "DT001_BORUTA40" )
  
  DR_drifting_guantesblancos( "DR001_BORUTA40", "CA001_BORUTA40" )
  FE_historia_guantesblancos( "FE001_BORUTA40", "DR001_BORUTA40" )
  
  TS_strategy_guantesblancos_202109( "TS001_BORUTA40", "FE001_BORUTA40" )
  
  HT_tuning_guantesblancos( "HT001_BORUTA40", "TS001_BORUTA40" )
  
  # El ZZ depente de HT y TS
  ZZ_final_guantesblancos( "ZZ001_BORUTA40", c("HT001_BORUTA40","TS001_BORUTA40") )
