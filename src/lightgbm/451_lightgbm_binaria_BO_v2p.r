...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_data_in_leaf", lower = 200L, upper = 3000L),
  makeIntegerParam("num_leaves", lower = 100L, upper = 1800L),
  makeIntegerParam("envios", lower = 9000L, upper = 15000L)
)
